        ...
        <div class="doc-content-container" style="margin: 0 auto;">
            <div class="doc-content">
                <div>
                    <h1>ScList用法</h1>
                    <p>用于显示一个列表数据。</p>
                    <sc-code :code="code1" title="基础用法" desc="用于显示一个列表数据。">
                        <sc-table :data="data1" />
                    </sc-code>
                    <sc-code :code="code2" title="带图标" desc="用于显示一个列表数据，可以指定图标。">
                        <sc-list :data="data2" icon="sc-folder-open-line" />
                    </sc-code>
                    <sc-code :code="code2" title="显示头信息" desc="用于显示一个列表数据，可以指定图标。">
                        <sc-list :data="data2" icon="sc-folder-open-line" header="颜色" />
                    </sc-code>
                    <sc-code :code="code2" title="显示头信息" desc="用于显示一个列表数据，可以指定图标。">
                        <sc-list :data="data2" icon="sc-folder-open-line">
                            <template #header>
                                <div style="font-size: 17px;padding: 15px 20px;">
                                    <span class="scfont sc-layers-fill"></span>
                                    颜色
                                </div>
                            </template>
                        </sc-list>
                    </sc-code>
                    <sc-code :code="code2" title="显示尾信息" desc="用于显示一个列表数据，可以指定图标。">
                        <sc-list :data="data2" icon="sc-folder-open-line" header="颜色">
                            <template #footer>
...
export default {
    ...
    data() {
        return {
            code1: `\x3csc-list :data="list" /\x3e
\x3cscript\x3e 
export default{
    data(){
        return {
...
\x3c/script\x3e`,
            data1: [{ id: 1, label: '红色', value: '1' },
            { id: 2, label: '黄色', value: '2' },
            { id: 3, label: '蓝色', value: '3' }
            ],
            code2: `\x3csc-list :data="list" icon="sc-folder-open-line" /\x3e
\x3cscript\x3e 
export default{
    data(){
        return {
