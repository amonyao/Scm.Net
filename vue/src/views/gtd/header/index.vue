	...
	data() {
		return {
			...
			column: [
				...
				{ prop: 'user_id', label: '', width: 100 },
				{ prop: 'cat_id', label: '', width: 100 },
				...
				{ prop: 'cron', label: '表达式', width: 100 },
				{ prop: 'notice', label: '提示方式', width: 100 },
				{ prop: 'last_time', label: '上次提醒时间', width: 100 },
				{ prop: 'next_time', label: '下次提醒时间', width: 100 },
