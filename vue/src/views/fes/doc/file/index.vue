	...
	data() {
		return {
			...
			column: [
                ...
                { prop: 'pid', label: '类别', width: 100 },
                { prop: 'types', label: '', width: 100 },
                { prop: 'modes', label: '', width: 100 },
                { prop: 'codes', label: '', width: 100 },
                { prop: 'codec', label: '短链编码', width: 100 },
                ...
                { prop: 'exts', label: '扩展名', width: 100 },
                { prop: 'size', label: '文件大小', width: 100 },
                { prop: 'refs', label: '引用数量', width: 100 },
                { prop: 'tags', label: '标签数量', width: 100 },
                { prop: 'favs', label: '收藏数量', width: 100 },
                { prop: 'remark', label: '备注', width: 100 },
                { prop: 'file_create_time', label: '文件创建时间', width: 100 },
                { prop: 'file_modify_time', label: '文件修改时间', width: 100 },
