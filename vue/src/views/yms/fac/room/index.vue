...
export default {
	...
	data() {
		return {
			...
			column: [
				...
				{ prop: 'area_id', label: '所属园区', width: 100, align: 'left' },
				{ prop: 'build_id', label: '所属楼宇', width: 100, align: 'left' },
				{ prop: 'floor_id', label: '所属楼层', width: 100, align: 'left' },
	...
	methods: {
		...
		list_floor() {
			...
			this.$SCM.list_option(this.build_list, this.$API.ymsfacbuild.option, { pid: this.param.build_id }, true);
		}
	},
};
</script>
