			...
			<el-col :span="24">
				<el-card class="box-card">
					...
					<el-descriptions :column="3" border>
						...
						<el-descriptions-item label="Tick数量">{{ os.tickCount }}</el-descriptions-item>
			...
			<el-col :span="24">
				<el-card class="box-card">
					...
					<el-descriptions :column="3" border>
						...
						<el-descriptions-item label="网卡MAC">{{ netWork.mac }}</el-descriptions-item>
						<el-descriptions-item label="网卡信息">{{ netWork.trademark }}</el-descriptions-item>
					</el-descriptions>
				</el-card>
			</el-col>
		</el-row>
