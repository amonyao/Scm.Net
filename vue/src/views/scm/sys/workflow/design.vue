<template>
	<el-container>
		<el-header>
			...
			<div class="flow-tab">
				<span :class="tabIndex == 0 ? 'active' : ''" @click="tabIndex = 0">1.基础信息</span>
				<span :class="tabIndex == 1 ? 'active' : ''" @click="tabIndex = 1">2.配置流程</span>
			</div>
						...
						<el-row :gutter="25">
							<el-col :span="12">
								<el-form-item label="审批流名称" prop="title">
									<el-input v-model="formData.title" placeholder="请输入审批流名称" :maxlength="50"
							...
							<el-col :span="12">
								<el-form-item label="图标" prop="icon">
									<el-input v-model="formData.icon" placeholder="请输入图标" clearable
							...
							<el-col :span="24">
								<el-form-item label="流程说明 （请填写相关注意事项，方便员工在申请时查阅）" prop="summary">
									<el-input v-model="formData.summary" type="textarea" placeholder="请输入流程说明 "
										:maxlength="200" show-word-limit :autosize="{ minRows: 4, maxRows: 4 }"
										:style="{ width: '100%' }"></el-input>
								</el-form-item>
							</el-col>
						</el-row>
