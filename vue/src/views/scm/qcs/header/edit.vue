	...
	<sc-dialog v-model="visible" show-fullscreen destroy-on-close :title="titleMap[mode]" width="750px" @close="close">
		<el-form ref="formRef" label-width="100px" :model="formData" :rules="rules">
			<el-form-item label="系统代码" prop="codes">
				<el-input v-model="formData.codes" placeholder="请输入系统代码" :maxlength="16" show-word-limit
					clearable></el-input>
			</el-form-item>
			...
			<el-form-item label="系统名称" prop="names">
				<el-input v-model="formData.names" placeholder="请输入系统名称" :maxlength="16" show-word-limit
					clearable></el-input>
			</el-form-item>
			...
			<el-form-item label="队列数量" prop="qty">
				<el-input v-model="formData.qty" placeholder="请输入队列数量" :maxlength="11" show-word-limit clearable></el-input>
			</el-form-item>
