...
export default {
	...
	methods: {
		async init() {
			...
			var res = await this.$API.scmcfgexportdetail.page.get(this.param);
		...
		async status_item(e, row) {
			this.$SCM.status_item(this, this.$API.scmcfgexportdetail.status, row, row.row_status);
		},
		status_list(status) {
			this.$SCM.status_list(this, this.$API.scmcfgexportdetail.status, this.selection, status);
		},
		async delete_item(row) {
			this.$SCM.delete_item(this, this.$API.scmcfgexportdetail.delete, row);
		},
		delete_list() {
			this.$SCM.delete_list(this, this.$API.scmcfgexportdetail.delete, this.selection);
		},
		show_search() {
