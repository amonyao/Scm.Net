<template>
	<sc-dialog v-model="visible" show-fullscreen :title="titleMap[mode]" width="750px" @close="close">
		<el-form ref="formRef" :model="formData" :rules="rules" label-width="100px">
			<el-row>
				<el-col :span="12">
					<el-form-item label="任务分组" prop="groupName">
						<el-input v-model="formData.groupName" placeholder="请输入任务分组任务分组" :maxlength="30" show-word-limit
							clearable :style="{ width: '100%' }"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="间隔时间" prop="interval">
						<sc-cron v-model="formData.interval" placeholder="请输入Cron定时规则" clearable></sc-cron>
					</el-form-item>
				</el-col>
				<el-col :span="12">
				...
				<el-col :span="12">
					<el-form-item label="任务类型" prop="taskType">
						<el-select v-model="formData.taskType" placeholder="请选择任务类型" clearable :style="{ width: '100%' }">
				...
				<el-col :span="12">
					<el-form-item v-if="formData.taskType == 2" label="请求类型" prop="apiRequestType">
			...
			<el-form-item v-if="formData.taskType == 1" label="类名" prop="dllClassName">
				<el-input v-model="formData.dllClassName" placeholder="请输入任务执行类名" :maxlength="200" show-word-limit clearable
					:style="{ width: '100%' }"></el-input>
			</el-form-item>
			<el-form-item v-if="formData.taskType == 2" label="请求地址" prop="apiUrl">
				<el-input v-model="formData.apiUrl" placeholder="请输入请求地址" :maxlength="200" show-word-limit clearable
					:style="{ width: '100%' }"></el-input>
			</el-form-item>
			<el-row>
				<el-col :span="12">
					<el-form-item v-if="formData.taskType == 2" label="授权名">
						<el-input v-model="formData.apiAuthKey" placeholder="请输入授权名" :maxlength="200" show-word-limit
							clearable :style="{ width: '100%' }"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item v-if="formData.taskType == 2" label="授权值">
						<el-input v-model="formData.apiAuthValue" placeholder="请输入授权值" :maxlength="500" show-word-limit
							clearable :style="{ width: '100%' }"></el-input>
					</el-form-item>
				</el-col>
			</el-row>
			<el-form-item v-if="formData.taskType == 2" label="请求参数">
				<el-input v-model="formData.apiParameter" type="textarea" placeholder="请输入请求参数" :maxlength="800"
