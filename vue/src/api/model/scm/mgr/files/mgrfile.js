...
export default {
	list: {
		url: `${config.API_URL}/mgrfile/folders`,
		name: "列表",
	...
	files: {
		url: `${config.API_URL}/mgrfile/files`,
		name: "查询文件列表",
		get: async function (params) {
			return await http.get(this.url, params);
		},
	...
	view: {
		url: `${config.API_URL}/mgrfile/view`,
		name: "查看",
		get: async function (params) {
			return await http.get(this.url + params);
		},
	...
	upload: {
		url: `${config.API_URL}/mgrfile/upload`,
		name: "文件上传",
	...
	delFile: {
		url: `${config.API_URL}/mgrfile/file`,
		name: "删除文件",
	...
	delFolder: {
		url: `${config.API_URL}/mgrfile/folder`,
		name: "删除目录",
		delete: async function (params) {
			return await http.delete(this.url + "?path=" + params);
		},
	...
	adv: {
		url: `${config.API_URL}/mgrfile/uploading`,
		name: "上传广告位",
