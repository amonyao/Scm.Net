...
namespace Com.Scm.Iam.Log
{
    ...
    public class IamLogTicketService : ApiService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<IamLogTicketDvo>> GetPagesAsync(ScmSearchPageRequest request)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<List<IamLogTicketDvo>> GetListAsync(ScmSearchRequest request)
        {
            var result = await _thisRepository.AsQueryable()
        ...
        private void Prepare(List<IamLogTicketDvo> list)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogTicketDvo> GetAsync(long id)
        {
            var model = await _thisRepository.GetByIdAsync(id);
            return model.Adapt<IamLogTicketDvo>();
        }
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogTicketDvo> GetEditAsync(long id)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogTicketDvo> GetViewAsync(long id)
        {
            return await _thisRepository
                .AsQueryable()
                .Select<IamLogTicketDvo>()
