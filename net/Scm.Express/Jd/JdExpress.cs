using Com.Scm.Express.JdExpress.ShipperSearch;
...
namespace Com.Scm.Express.JdExpress
{
    public class JdExpress
    {
        ...
        {
            var d = new ShipperSearchResponse();

            var body = "[\"0\"]";

            var jdRequest = new JdShipperSearchRequest();
            var jdResponse = Request<JdShipperSearchResponse>(jdRequest, body);
        ...
        private T Request<T>(JdRequest req, string json) where T : class, new()
        {
