...
namespace Com.Scm.Fes.Doc
{
    ...
    public class FesResTagService : ApiService
    {
        ...
        /// <returns></returns>
        public FesResTagService(SugarRepository<TagDao> thisRepository, SugarRepository<UserDao> userRepository)
        {
        ...
        public async Task<bool> AddAsync(TagDto model)
        {
            ...
            return await _thisRepository.InsertAsync(model.Adapt<TagDao>());
        }
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public async Task UpdateAsync(TagDto model)
        {
            if (string.IsNullOrWhiteSpace(model.names))
            {
                model.names = model.namec;
