...
using Com.Scm.Utils;
using Com.Scm.Yms.Fac.Build.Dvo;
using Microsoft.AspNetCore.Mvc;

namespace Com.Scm.Yms.Fac.Build
{
    /// <summary>
    /// 楼宇服务接口
    /// </summary>
    ...
    public class YmsFacBuildService : ApiService
    {
        ...
        public YmsFacBuildService(SugarRepository<YmsFacBuildDao> thisRepository,
        ...
        {
            var result = await _thisRepository.AsQueryable()
                .Where(a => a.row_status == Enums.ScmStatusEnum.Enabled && a.area_id == request.pid)
                .OrderBy(a => a.id)
