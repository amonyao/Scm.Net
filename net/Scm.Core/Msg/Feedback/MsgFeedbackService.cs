using Com.Scm.Dsa;
using Com.Scm.Msg.Feedback.Dvo;
...
namespace Com.Scm.Msg.Feedback
{
    /// <summary>
    /// 
    /// </summary>
    [ApiExplorerSettings(GroupName = "Msg")]
    public class MsgFeedbackService : ApiService
    {
        ...
        /// 
        /// </summary>
        public MsgFeedbackService(SugarRepository<FeedbackHeaderDao> headerRepository,
