...
namespace Com.Scm.Msg.CommentDetail
{
    ...
    public class MsgCommentDetailService : ApiService
    {
        ...
        public MsgCommentDetailService(SugarRepository<CommentDetailDao> thisRepository, IUserService userService)
        {
