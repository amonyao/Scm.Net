...
using Com.Scm.Msg.FeedbackHeader.Dvo;
using Com.Scm.Service;
using Com.Scm.Utils;
using Microsoft.AspNetCore.Mvc;

namespace Com.Scm.Msg.FeedbackHeader
{
    /// <summary>
    /// 服务接口
    /// </summary>
    [ApiExplorerSettings(GroupName = "Msg")]
    public class MsgFeedbackHeaderService : ApiService
    {
        ...
        /// <returns></returns>
        public MsgFeedbackHeaderService(SugarRepository<FeedbackHeaderDao> thisRepository, IUserService userService)
        {
