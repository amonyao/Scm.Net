...
public class SysNoticeService : ApiService
{
    ...
    public SysNoticeService(SugarRepository<NoticeDao> thisRepository
    ...
    public async Task<ScmSearchPageResponse<NoticeDvo>> SearchSjAsync(SearchRequest param)
    {
        ...
        for (var i = 0; i < result.Items.Count; i += 1)
        {
            ...
            var userDao = _UserService.GetUser(dao.send_user);
