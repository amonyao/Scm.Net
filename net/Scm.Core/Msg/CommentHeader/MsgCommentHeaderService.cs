...
namespace Com.Scm.Msg.CommentHeader
{
    ...
    public class MsgCommentHeaderService : ApiService
    {
        ...
        /// <returns></returns>
        public MsgCommentHeaderService(SugarRepository<CommentHeaderDao> thisRepository, IUserService userService)
        {
