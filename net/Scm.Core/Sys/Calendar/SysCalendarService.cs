...
public class SysCalendarService : IApiService
{
    ...
    public SysCalendarService(SugarRepository<CalendarDao> thisRepository, JwtContextHolder jwtContextHolder, ISqlSugarClient client)
    {
