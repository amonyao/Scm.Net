...
public class SysDicDetailService : ApiService
{
    ...
    public SysDicDetailService(SugarRepository<DicDetailDao> thisRepository, SugarRepository<DicHeaderDao> headerRepository)
    {
