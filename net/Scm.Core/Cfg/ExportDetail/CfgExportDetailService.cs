...
namespace Com.Scm.Cfg.ExportDetail
{
    ...
    /// 
    /// </summary>
    public class CfgExportDetailService : ApiService
    {
        ...
        public CfgExportDetailService(SugarRepository<ExportDetailDao> thisRepository, SugarRepository<ExportHeaderDao> headerRepository)
        {
