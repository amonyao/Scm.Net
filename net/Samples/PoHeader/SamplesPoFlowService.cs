...
namespace Com.Scm.Samples.PoHeader
{
    ...
    public class SamplesPoFlowService : ApiFlowService
    {
        ...
        public async Task<bool> SubmitAsync(long id)
        {
            ...
            // 查询流程
            var flowOrderDao = await GetFlowOrderAsync(dao.unit_id, SamplesPoHeaderDto.FLOW_CODE);
            ...
            return await StartFlow(flowOrderDao, orderId, orderCode, dao.update_user, dao.unit_id);
        }
