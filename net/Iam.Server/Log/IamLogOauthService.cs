...
namespace Com.Scm.Iam.Log
{
    ...
    public class IamLogOauthService : ApiService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<IamLogOauthDvo>> GetPagesAsync(ScmSearchPageRequest request)
        {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<List<IamLogOauthDvo>> GetListAsync(ScmSearchRequest request)
        {
            var result = await _thisRepository.AsQueryable()
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogOauthDvo> GetAsync(long id)
        {
            var model = await _thisRepository.GetByIdAsync(id);
            return model.Adapt<IamLogOauthDvo>();
        }
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogOauthDvo> GetEditAsync(long id)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<IamLogOauthDvo> GetViewAsync(long id)
        {
            return await _thisRepository
                .AsQueryable()
                .Select<IamLogOauthDvo>()
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public async Task UpdateAsync(IamLogOauthDto model)
        {
